...
const HomeThreeNavBar = () => {
   ...
   const logout = () => {
      ...
      getApiWithToken(`${BaseUrl.BaseUrlVariable}/logout`, " ", Token)
         .then(({ data }) => {
            // setLoader(true);
            if (data.status) {
   ...
   return (
      <>
                  ...
                  <div className={"row align-items-center"}>
                     <div className="col-xl-4 col-lg-4 col-md-6 col-6">
                        <div className="logo logo-3 pos-rel">
                           <Link to="/"><img src="img/logo/24ur-logo.png" alt="" /></Link>
                     ...
                     <div className="col-xl-8 col-lg-8 col-md-8 d-none d-lg-block">
                        ...
                        <div className="header-cta-info header-cta-info-3 d-flex f-left">
                           ...
                           <div className="header-cta-text">
                              ...
                              <span className="primary-color">HnhTechSolutions@gmail.com</span>
                           </div>
                        </div>
                        <div className="header-cta-info header-cta-info-3 d-flex f-left">
                           <div className="header-cta-icon">
                           ...
                           <div className="header-cta-text">
                              ...
                              <span className="primary-color">(021) 37459970 </span>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div className="header__menu menu-dark">
                           <nav id="mobile-menu">
                              <ul>
                                 ...
                                 {/* for static links without pages */}
                                 ...
                                 {/* {
                                    Token != null ? <li><Link to="/profile" >Profile</Link></li> : null
                                 }

                                 {
                                    Token != null ? <li onClick={() => logout()} ><Link to="" >Logout</Link></li> : null
                                 } */}
         ...
         <Sidebar show={show} handleClose={handleClose} tken={Token}  />
      </>
   );
};
