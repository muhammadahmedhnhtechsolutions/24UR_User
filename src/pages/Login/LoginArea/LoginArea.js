   ...
   const onSubmit = data => {
      ...
      // navigate('/welcome')
          ...
          let formdata = new FormData();
            ...
            PostApiWithOutToken(`${BaseUrl.BaseUrlVariable}/login`, formdata,)
			.then(({ data }) => {
               ...
               <div className="row">
                  <div className="col-lg-8 offset-lg-2">
                     <div className="basic-login">
                        <h3 className="text-center mb-60">Login With 24UR</h3>
                        <form onSubmit={handleSubmit(onSubmit)}>
                           ...
                           <div className="login-action mb-20 fix">
                              ...
                              <span onClick={() =>navigate('/forgetpassword')} className="forgot-login f-right">
