                     ...
                     <div className="col-xl-4 col-lg-6 col-md-6">
                        <div className="footer-contact-info footer-contact-info-3 mb-40">
                           <div className="footer-logo mb-35">
                              <Link to="/"><img src="img/logo/24ur-4.png" alt="" /></Link>
                           </div>
                           ...
                           <div className="footer-emailing">
                              <ul>
                                 <li><i className="far fa-envelope"></i>HnhTechSolutions@gmail.com</li>
                                 <li><i className="far fa-clone"></i>HnhTechSolutions.com</li>
                                 <li><i className="far fa-flag"></i>227 Marion Street, Pakistan</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                        ...
                        <div className="footer-widget mb-40">
                           ...
                           <div className="footer-menu footer-menu-2">
                              <ul>
                                 ...
                                 <li><Link to="#">Surgery and Radiology</Link></li>
                  ...
                  <div className="row">
                     <div className="col-xl-12">
                        <div className="footer-copyright footer-copyright-3 text-center">
                           <p>Copyright by@ HNH TECH SOLUTIONS - 2023</p>
                        </div>
                     </div>
                  </div>
               </div>
